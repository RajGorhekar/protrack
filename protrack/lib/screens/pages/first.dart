...
class _FirstState extends State<First> {
  ...
  void getUsageStats() async {
    try {
      DateTime startDate = DateTime(2021, 02, 13, 09, 00); // to be done
    ...
    return SingleChildScrollView(
      child: Column(children: [
                    ...
                    if (distanceInMeters <= 600) {
                      ...
                      if (bssid == curr_bssid) {
                        ...
                        await Firestore.instance
                            ...
                            .doc('attendance')
                            .update({
                          date.toString().substring(0, 11).trim(): "Present"
                        });
                        setState(() {
                          status = 3;
                      ...
                      showerror("You are not in our whitelisted GeoFence\n");
                    }
                  },
                  child: Container(
                      width: double.maxFinite,
        ...
        Padding(
          padding: const EdgeInsets.symmetric(horizontal: 15),
          child: Header(
              Icon(Icons.work_outline_sharp, color: Colors.cyan, size: 35),
...
Future<Position> _determinePosition() async {
  ...
  //   var todays_data = data[date.toString().substring(0, 11).trim()];
